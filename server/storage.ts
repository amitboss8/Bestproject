...
export class MemStorage implements IStorage {
  ...
  private initializeOTPServices() {
    const services = [
      ...
      { id: 143, name: "Telegram", price: "2.00", icon: "SiTelegram" },
      { id: 144, name: "Instagram", price: "4.00", icon: "SiInstagram" },
      { id: 145, name: "Facebook", price: "3.00", icon: "SiFacebook" },
      { id: 146, name: "Snapchat", price: "4.00", icon: "SiSnapchat" },
      { id: 147, name: "Twitter (X)", price: "5.00", icon: "SiTwitter" },
      { id: 148, name: "TikTok", price: "2.00", icon: "SiTiktok" },
      { id: 149, name: "Hike", price: "1.00", icon: "SiHipchat" },
      { id: 150, name: "Reddit", price: "3.00", icon: "SiReddit" },
      { id: 151, name: "Discord", price: "2.00", icon: "SiDiscord" },
      { id: 152, name: "Clubhouse", price: "3.00", icon: "SiClubhouse" },
      { id: 153, name: "Threads", price: "2.00", icon: "SiThreads" },
      { id: 154, name: "Amazon", price: "4.00", icon: "SiAmazon" },
      { id: 155, name: "Flipkart", price: "5.00", icon: "SiFlipkart" },
      { id: 156, name: "Myntra", price: "3.00", icon: "SiMyntra" },
      { id: 157, name: "Ajio", price: "4.00", icon: "SiAframe" },
      { id: 158, name: "Nykaa", price: "3.00", icon: "SiNintendo" },
      { id: 159, name: "Tata CLiQ", price: "5.00", icon: "SiTata" },
      { id: 160, name: "Meesho", price: "2.00", icon: "SiMessenger" },
      { id: 161, name: "ShopClues", price: "3.00", icon: "SiShopify" },
